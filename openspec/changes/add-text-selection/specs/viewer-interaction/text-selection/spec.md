# viewer-interaction/text-selection Delta
...
- **THEN** every text item between anchor and current pointer is highlighted while dragging and remains highlighted after release
...
- **THEN** highlights follow the selected items across those lines and pages
